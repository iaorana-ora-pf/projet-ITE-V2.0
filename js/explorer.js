...
function sortTimeline() {
  ...
  // 📦 Sélectionne le conteneur principal de la frise
  const timelineContainer = document.querySelector(".timeline");

  // 🧱 Récupère tous les éléments enfants de la frise (événements)
  const events = Array.from(timelineContainer.children);

  // 🔢 Trie les éléments selon leur data-date (doit être au format YYYY-MM-DD)
  events.sort((a, b) => {
